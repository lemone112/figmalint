    ...
    try {
      ...
      try {
        ...
        if (raw) {
          ...
          console.log(`Restored ${((_a = state.nodeIds) == null ? void 0 : _a.length) || 0} ignored nodes, ${((_b = state.errorKeys) == null ? void 0 : _b.length) || 0} ignored errors`);
        }
      } catch (e) {
      }
